...
temp = load(fullfile(datadir,'data4plot/bearing_data', 'bearing_data.mat'));
bt_data = temp.Bpairs(2,:);
bpair_data = temp.Bpairs;
temp = load(fullfile(datadir,'data4plot/bearing_data', 'bearing_staPAW.mat'));
bt_stapaw = temp.Bpairs(2,:);
bpair_stapaw = temp.Bpairs;
temp = load(fullfile(datadir,'data4plot/bearing_data', 'bearing_woF.mat'));
bt_wof = temp.Bpairs(2,:);
bpair_wof = temp.Bpairs;
temp = load(fullfile(datadir,'data4plot/bearing_data', 'bearing_dPAW.mat'));
bt_dpaw = temp.Bpairs(2,:);
bpair_dpaw = temp.Bpairs;
temp = load(fullfile(datadir,'data4plot/bearing_data', 'bearing_turn_in_state.mat'));
bt_turnin = temp.Bpairs(2,:);
bpair_turnin = temp.Bpairs;
%%
temp = load(fullfile(datadir,'data4plot/bearing_data', 'turns_staPAW2.mat'));
tr_stapaw = temp.Bpairs(2,:);
tpair_stapaw = temp.Bpairs;
temp = load(fullfile(datadir,'data4plot/bearing_data', 'turns_data.mat'));
