...
% load(fullfile(datadir,'data4plot/salt_chemotaxis', 'Data_salt100_50_staPAW2.mat'));
load(fullfile(datadir,'data4plot/salt_chemotaxis', 'Data_salt0_50_staPAW.mat'));
...
%% Figure 3 B and 1A
%%% plotting tracks and states for spatial analysis
pix2mm = 1/31.5;
[aa,bb] = max( gams_ ,[], 1 );
...
fac_mms = 1/33*14/5;  %%% scaling for mm/s
figure
[aa,bb] = max( gams_ ,[], 1 );
for kk = 1:nStates %nStates:-1:1 %
...
%% Figure 1E and 3A
%%% example long track for visualization
...
%% time evolution analysis, for SI
bins = 11;
[aa,bb_] = max( gams_ ,[], 1 );
...
%% compute dwell time statsitics, for SI
bins = 100;
rescale_t = 5/14;
[aa,bb] = max( gams_ ,[], 1 );
...
%% Figure 2E
%%% model prediction for autocorrelation
figure;
