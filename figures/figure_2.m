...
%% load data
% load(fullfile(datadir,'data4plot/salt_chemotaxis', '20240319_110114_cv_staPWA.mat')); %%% Data_salt0_50
% load(fullfile(datadir,'data4plot/salt_chemotaxis', '20240324_114402_cv_staPWA.mat')); %%% Data_salt100_50
% load(fullfile(datadir,'data4plot/salt_chemotaxis', '20240527_060158_cv_staPWA.mat'));

%%% demo with this
load(fullfile(datadir,'data4plot/salt_chemotaxis', '20240618_233016_cv_staPWA.mat'));
