...
ka = 0.5;
kd = 0.05;
Cm = 3;    %non-equilibrium effect of agar capacity (0 for without agar and higher for large plate)
...
%%
figure();
subplot(131);pcolor(x, y, wo_f);shading interp; colormap(jet); set(gca,'FontSize',20)
subplot(132);pcolor(x, y, ne_f);shading interp; colormap(jet); set(gca,'FontSize',20)
subplot(133);pcolor(x, y, eq_f);shading interp; colormap(jet); set(gca,'FontSize',20)
colorbar; 
xlabel('x-axis [cm]'); ylabel('y-axis [cm]');
set(gcf,'color','w');